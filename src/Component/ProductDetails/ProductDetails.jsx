    ...
    <div className="col-2 col-md-1">
        <div className="d-flex flex-column pt-3">
            {product.images.map((img)=> 
                <div key={img} onClick={()=>{displayImg(img)}}  className="div">
      ...
      <div className="col-10  col-md-3 ">
          <img  className='w-100 rounded-5 ' src={spacificImg||product.imageCover} alt="" />
      </div>
      <div className="col-md-8  pt-5">
        ...
        <p><i className="rating-color fa-solid fa-star"></i>{product.ratingsAverage} |{product.ratingsQuantity} Rating</p>
        </div>
        <button onClick={()=>{addToCart(product._id)}} className='w-100 text-white bg-success btn mb-5 fs-5'>Add to cart</button>
      </div>
  </div>
</div>}
